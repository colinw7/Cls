...
class Cls {
 ...
 ~Cls();
  ...
  char typeChar(ClsFile *file) const;
  bool isBadFile(ClsFile *file) const;
  bool isBadLink(ClsFile *file) const;
  ...
  std::string sizeToString(ClsData *) const;
  std::string sizeToString(size_t size) const;
  void        formatSize(size_t size) const;
